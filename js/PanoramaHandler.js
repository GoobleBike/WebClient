...
function PanoramaHandler(elementId,heading) {
    //
    this.elementId= elementId;
    this.centerLtLn = {lat: 44.489623, lng: 11.309306};//"44.489623,11.309306","44.479385,11.296335"
    this.sv = new google.maps.StreetViewService();
    this.heading = heading;
    this.panorama = new google.maps.StreetViewPanorama(document.getElementById(this.elementId));
...
PanoramaHandler.prototype.newPanorama = function(latLng,heading) {
    this.heading=heading;
    this.sv.getPanorama({location: latLng, radius: 50}, this.processSVData);
}
